//
//  SelectImageFromTableViewController.swift
//  Dogstagram
//
...
class SelectImageFromTableViewController: UITableViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {

    @IBAction func openPhotoLibraryPressed(_ sender: UIButton) {
        /*
